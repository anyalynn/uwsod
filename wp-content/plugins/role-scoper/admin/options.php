...
if ( $sitewide || ! IS_MU_RS ) : ?>
	...
	echo '<table id="rs-admin-info" style="max-width: 80em">'
		...
		. '<th width="80%" style="font-weight:normal">' . _awp( 'Description' ) . '</th>'
		. '</tr>';
...
if ( ! empty( $ui->form_options[$tab][$section] ) ) : ?>
	...
	<?php if ( in_array( 'hide_non_editor_admin_divs', $ui->form_options[$tab][$section] ) ) :
		...
		$admin_caption = ( ! empty($custom_content_admin_cap) ) ? __('Content Administrator', 'scoper') : _awp('Administrator');
		
		$captions = array( '0' => __('no requirement', 'scoper'), '1' => __('Contributor / Author / Editor', 'scoper'), 'author' => __('Author / Editor', 'scoper'), 'editor' => _awp('Editor'), 'admin_content' => __('Content Administrator', 'scoper'), 'admin_user' => __('User Administrator', 'scoper'), 'admin_option' => __('Option Administrator', 'scoper') );
