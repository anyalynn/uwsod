...
<?php if ( ! $suppress_groups_list) :?>
	...
	if ( isset($results) && count($results) ) {
		...
		<tr class="thead">
			<th><?php echo _awp('Name'); ?>
			</th>
			<th><?php echo _awp('Description'); ?></th>
		...
		<tr <?php echo $style; ?>>
			...
			<a class="delete"
				href="<?php echo($url);?>"
				onClick="return DelConfirm('<?php echo $result->display_name; ?>');"><?php echo _awp('Delete');?></a>
			<?php endif;?>
			</td>
		</tr>
...
<table style="width: 100%;">
	<tr>
		...
		<td style="width:4em;"><strong><?php echo _awp('Name');?>:</strong></td>
	...
	<tr>
		<td>&nbsp;</td>
		<td style="vertical-align:top;"><strong><?php echo _awp('Description');?>:</strong></td>
