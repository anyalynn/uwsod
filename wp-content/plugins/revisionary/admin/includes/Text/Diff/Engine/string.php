...
class Text_Diff_Engine_string {
    ...
    function parseUnifiedDiff($diff)
    {
        ...
        for ($i = 0; $i < $end;) {
            ...
            case ' ':
				...
				$tmp1 = new Text_Diff_Op_copy($diff1);
                $edits[] =& $tmp1;
                break;
            ...
            case '+':
				...
				$tmp2 = new Text_Diff_Op_add($diff1);
                $edits[] =& $tmp2;
                break;
            ...
            case '-':
                ...
                if (count($diff2) == 0) {
					$tmp3 = new Text_Diff_Op_delete($diff1);
                    $edits[] =& $tmp3;
                } else {
					$tmp4 = new Text_Diff_Op_change($diff1, $diff2);
                    $edits[] =& $tmp4; 
                }
                break;
    ...
    function parseContextDiff(&$diff)
    {
        ...
        while ($i < $end && $j < $end) {
            ...
            if (count($array) > 0) {
				$tmp1 = new Text_Diff_Op_copy($array);
                $edits[] =& $tmp1;
            }
            ...
            if ($i < $max_i) {
                ...
                case '!':
					...
					$tmp2 = new Text_Diff_Op_change($diff1, $diff2);
                    $edits[] =& $tmp2;
                    break;
                ...
                case '+':
					...
					$tmp3 = new Text_Diff_Op_add($diff1);
                    $edits[] =& $tmp3;
                    break;
                ...
                case '-':
					...
					$tmp4 = new Text_Diff_Op_delete($diff1);
                    $edits[] =& $tmp4;
                    break;
                }
            }
            ...
            if ($j < $max_j) {
                ...
                case '+':
					...
					$tmp5 = new Text_Diff_Op_add($diff2);
                    $edits[] =& $tmp5;
                    break;
                ...
                case '-':
					...
					$tmp6 = new Text_Diff_Op_delete($diff2);
                    $edits[] =& $tmp6;
                    break;
                }
            }
